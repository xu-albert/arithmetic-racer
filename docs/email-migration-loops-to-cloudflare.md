...
|---|---|---|---|
| Welcome | `worker/auth.js:194` | `LOOPS_TEMPLATE_WELCOME` | signup, no variables |
| Password reset | `worker/auth.js:103` | `LOOPS_TEMPLATE_RESET` | better-auth callback, passes `resetUrl` |
...
- `worker/auth.js:66` — imports `sendResetEmail`, `sendWelcomeEmail`.
