...
|---|---|---|---|
| Welcome | `worker/auth.js:224` | `LOOPS_TEMPLATE_WELCOME` | signup, no variables |
| Password reset | `worker/auth.js:111` | `LOOPS_TEMPLATE_RESET` | better-auth callback, passes `resetUrl` |
