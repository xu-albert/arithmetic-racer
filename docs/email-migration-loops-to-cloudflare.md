...
|---|---|---|---|
| Welcome | `worker/auth.js:220` | `LOOPS_TEMPLATE_WELCOME` | signup, no variables |
| Password reset | `worker/auth.js:107` | `LOOPS_TEMPLATE_RESET` | better-auth callback, passes `resetUrl` |
