...
- **Auth**: better-auth handles email/password and Google OAuth (`worker/auth.js`,
  ...
  `worker/claim.test.js` drives through the real sign-up endpoint (§4 #22) — flagged as a
  gap (§11).
