...
- **Auth**: better-auth handles email/password and Google OAuth (`worker/auth.js`,
  ...
  password reset (§4 #22); the rest of the auth flow is exercised only incidentally via
